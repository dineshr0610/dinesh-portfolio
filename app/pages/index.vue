      ...
      <div class="grid md:grid-cols-2 gap-8 md:gap-16 items-center mb-16 md:mb-24">
        ...
        <div class="relative flex flex-col items-center justify-end md:justify-center pt-16 md:pt-28 lg:pt-32 pb-10 min-h-[340px] md:min-h-0">
          ...
          <div class="hidden md:flex flex-col items-center mb-4 self-center mt-auto">
            ...
            <p class="text-[11px] text-slate-500 tracking-wider uppercase font-semibold">AI Assistant by Dinesh</p>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
        ...
        <div class="flex flex-col">
          <div class="flex items-center justify-between mb-4 px-1">
            ...
            <NuxtLink
              to="/about"
              class="text-indigo-400 font-bold text-xs bg-indigo-500/[0.08] border border-indigo-500/20 px-3 py-1.5 rounded-full hover:bg-indigo-500/[0.14] transition-colors uppercase tracking-wide"
            >
              View All
            </NuxtLink>
          </div>
          ...
          <div class="flex-1 space-y-3 flex flex-col">
            <template v-if="featured.length">
              ...
              >
                <div class="relative w-28 md:w-36 flex-shrink-0 bg-black/20 overflow-hidden">
                  ...
                  <div
                    v-else
                    class="w-full h-full flex items-center justify-center text-slate-600 text-2xl"
                  >🖼️</div>
                </div>

                <div class="p-3 md:p-4 flex-1 flex flex-col justify-center min-w-0">
                  <div class="flex justify-between items-start gap-2 mb-1">
                    <h3 class="font-bold text-sm text-slate-100 group-hover:text-indigo-300 truncate transition-colors leading-tight">
                      {{ p.title }}
                    </h3>
                    <span
                      class="text-[9px] px-1.5 py-0.5 rounded uppercase font-bold tracking-wider flex-shrink-0"
                  ...
                  <div class="text-[10px] text-slate-500 font-medium tracking-wide mb-2">
                    {{ formatDuration(p) }}
                  </div>
                  ...
                  <div class="flex items-center justify-between mt-auto">
                    <div class="flex gap-1 overflow-hidden">
                      <span
                        ...
                        :key="t"
                        class="px-1.5 py-0.5 bg-white/[0.04] text-slate-500 text-[10px] rounded border border-white/[0.06] whitespace-nowrap"
                      >
                        {{ t }}
                      </span>
                    </div>
                    ...
                    <NuxtLink
                      :to="`/about#project-${p.id}`"
                      class="text-[10px] font-bold text-indigo-400 hover:text-indigo-300 flex items-center gap-1 group/link whitespace-nowrap bg-indigo-500/[0.06] px-2 py-1 rounded-md"
                    >
            ...
            <div
              v-else
              class="flex-1 flex items-center justify-center py-10 text-center text-slate-500 bg-white/[0.02] rounded-2xl border border-white/[0.04] border-dashed"
            >
          ...
          <div class="flex flex-col flex-1">
            ...
            <div class="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-5 flex-1">
              <div class="relative pl-4 border-l border-white/[0.08] space-y-6 py-1">
                <div
                  v-for="(item, index) in (timeline || []).slice(0, 3)"
                  :key="item.id || index"
                  class="relative"
                >
            ...
            <div class="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-5 flex-1">
              <div class="space-y-3">
                <div
                  ...
                  :key="ach.id"
                  class="flex gap-3 p-3 rounded-xl hover:bg-white/[0.04] transition-colors items-start"
                >
            ...
            <div class="bg-white/[0.03] rounded-2xl border border-white/[0.06] p-5 flex-1">
              <div class="grid grid-cols-2 gap-3">
                <template v-if="galleryThumbs.length">
                  <NuxtLink
                    to="/gallery"
                    v-for="g in galleryThumbs.slice(0, 4)"
                    :key="g.id"
                    class="aspect-square rounded-xl overflow-hidden relative group cursor-zoom-in border border-white/[0.06]"
                  >
                    <img
                      :src="getThumb(g)"
      ...
      <div class="mt-10 bg-gradient-to-br from-indigo-900/60 to-violet-900/50 rounded-3xl p-7 md:p-10 border border-indigo-500/20 relative overflow-hidden group mb-10">
        ...
        <div class="relative z-10 grid md:grid-cols-2 gap-8 items-center">
          <div class="text-center md:text-left space-y-5">
            ...
            <NuxtLink
              to="/contact"
              class="inline-flex items-center gap-2 bg-white text-indigo-900 px-7 py-3.5 rounded-xl font-bold text-base hover:bg-slate-100 hover:scale-[1.02] transition-all duration-200 shadow-lg"
            >
              Get In Touch
            </NuxtLink>
          </div>
          ...
          <div class="relative h-[360px] w-full flex items-center justify-center">
            <div class="w-full h-full relative rounded-2xl overflow-hidden border border-white/[0.08] bg-black/20 backdrop-blur-sm group/ai cursor-pointer">
              ...
              ></iframe>
              <NuxtLink to="/ask" class="absolute inset-0 z-20" aria-label="Chat with Dinesh AI" />
